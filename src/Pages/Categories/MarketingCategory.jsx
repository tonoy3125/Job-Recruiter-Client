...
const MarketingCategory = ({ market }) => {
    const { _id, name, category_name, deadline, minimum_price, maximum_price, description } = market
    return (
        <div>
            <div className="p-8 transition-colors duration-300 transform border shadow-2xl shadow-[#2980b9] cursor-pointer rounded-xl hover:border-transparent group hover:bg-blue-600 dark:border-gray-700 dark:hover:border-transparent">
