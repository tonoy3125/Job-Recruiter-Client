...
const GraphicsCategory = ({ graphic }) => {
    ...
    return (
        <div>
            <div>
                <div className="p-8 transition-colors duration-300 shadow-2xl shadow-[#2980b9] transform border cursor-pointer rounded-xl hover:border-transparent group hover:bg-blue-600 dark:border-gray-700 dark:hover:border-transparent">
