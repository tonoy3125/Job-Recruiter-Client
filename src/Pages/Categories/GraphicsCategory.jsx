    ...
    return (
        <div>
            <div className="mx-1 lg:mx-0">
                <div className="p-8 transition-colors duration-300 shadow-2xl shadow-[#2980b9] transform border cursor-pointer rounded-xl hover:border-transparent group hover:bg-[#870058] dark:border-gray-700 dark:hover:border-transparent">
