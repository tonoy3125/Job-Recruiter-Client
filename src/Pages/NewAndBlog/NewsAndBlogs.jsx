        ...
        <section className="py-6 sm:py-12 dark:bg-gray-800 dark:text-gray-100">
            <div className="container p-6 mx-auto space-y-8">
                <div className="space-y-2 text-center">
                    <h2 className="text-5xl text-[#1967d2] font-bold">News and Blogs</h2>
                    <p className="font-serif text-base dark:text-gray-400">Write and deliver news stories with the reader’s perspective in mind</p>
                </div>
